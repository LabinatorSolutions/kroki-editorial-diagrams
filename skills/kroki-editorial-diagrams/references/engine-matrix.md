...
| **Graphviz** | Highly complex directed acyclic graphs (DAGs), module imports. | Fragile auto-routing algorithms; easily looks cluttered. | **Medium** (configured in graph blocks). |
